  ...
  <div class="mod-prod-sku-table">
    <el-form-item>
      <el-table
        ...
        <el-table-column v-for="(leftTitle, index) in tableLeftTitles" :key="index" :label="leftTitle" header-align="center" align="center">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-input v-model="scope.row.productName" type="textarea" :disabled="!scope.row.status"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="price"
    ...
    methods: {
      ...
      skuAddProdName () {
        ...
        for (let i = 0; i < this.value.length; i++) {
          ...
          sku.productName = this.prodName + ' ' + sku.skuName
          skuList.push(sku)
        }
